...
<application> element:
    ...
    <provider
            android:name="at.fhtw.rss.EntityContentProvider"
            android:authorities="at.fhtw.rss.provider"/>
    */

    public class RssItemContentProvider extends ContentProvider {

    public static final String AUTHORITY = "at.fhtw.rss.provider.rssitem";
